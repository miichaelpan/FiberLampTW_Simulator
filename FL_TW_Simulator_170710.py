...
# 300ms -> 1 minute per rotation
# 150ms -> 30 sec per rotation
...
def main():
    ...
    # Intensity plots of fiberport and individual iber
...
# IF RUNNING INTO GLOBAL VARIABLE CONFUSION~~~~
...
# Run main program after initializing all the functions
main()
